...
def chat_with_ai(request):
    ...
    if request.method == 'POST':
        ...
        print(r)
        return render(request, 'inventory/resources/ai.html', {'cropType': cropType,'landArea': landArea,'season': season, 'response': response})
    return render(request, 'inventory/resources/ai.html', {})
...
def get_ai_response(cropType,landArea,season,soilquality):
    genai.configure(api_key="AIzaSyCCC2a27I6y5tH2P1e4qksb2Zu4efTxl1o")  # Set up your API key
